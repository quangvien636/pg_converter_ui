...
DROP FUNCTION IF EXISTS public.contacts_getoutfileexcel(integer, character varying);
CREATE OR REPLACE FUNCTION public.contacts_getoutfileexcel(
    IN userno integer DEFAULT 1,
...
BEGIN
	...
	ELSE
		...
		CREATE TEMP TABLE tabuser (UserSeq integer) ON COMMIT DROP;
