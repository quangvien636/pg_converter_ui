...
DROP FUNCTION IF EXISTS public.contacts_gethistorylist(integer, integer, integer, integer, integer, date, date);
CREATE OR REPLACE FUNCTION public.contacts_gethistorylist(
    ...
    IN searchdate1 date DEFAULT CURRENT_DATE,
    IN searchdate2 date DEFAULT CURRENT_DATE
...
BEGIN
	...
	IF SearchType = 1 THEN
		...
		(
			...
			WHERE U.RegUserNo = contacts_gethistorylist.userno
