-- ─── PROCEDURE→FUNCTION: contacts_updateuserinfo ───────────────────────────────
-- NOTE: SQL Server stored procedure converted to PostgreSQL function.
-- TODO: Review converted output — stored procedure semantics differ; test before use in production.
-- TODO: replace SETOF record — procedure returns results; add RETURNS TABLE(col type, ...) manually
-- TODO: procedure contains result-returning SELECT; replace SETOF record with correct column types
-- TODO: LEN was not fully converted; use length()
DROP FUNCTION IF EXISTS public.contacts_updateuserinfo(integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, character varying, integer, integer);
CREATE OR REPLACE FUNCTION public.contacts_updateuserinfo(
    INOUT seq integer DEFAULT 7959,
    IN firstname character varying DEFAULT '대표',
    IN lastname character varying DEFAULT 'Mr',
    IN callname character varying DEFAULT 'C',
    IN telinfo character varying DEFAULT '0,0,Cellular Phone,010-3654-0002$0,2,Company,02-515-36216',
    IN emailinfo character varying DEFAULT '0,Mr kim@naver.com',
    IN companyinfo character varying DEFAULT '0,뉴델,,',
    IN addressinfo character varying DEFAULT '0#0#Company###경기 김포시 월곶면 고정로 13###',
    IN homepageinfo character varying DEFAULT '',
    IN snsinfo character varying DEFAULT '',
    IN memo character varying DEFAULT '',
    IN share character varying DEFAULT '300',
    IN important integer DEFAULT 0,
    IN photo character varying DEFAULT '',
    IN userno integer DEFAULT 70,
    IN listgroup integer DEFAULT 1028
