...
- Generated SQL: `SELECT "public"."board_setshare"(0::integer, 0::integer, 0::integer, ''::character varying, ''::character varying);`
- SQLSTATE: `42883`
...
- Generated SQL: `SELECT "public"."board_updatefile"(0::bigint, 0::bigint, ''::character varying, 0::bigint, ''::character varying);`
- SQLSTATE: `42702`
- Error: column reference "fileno" is ambiguous
...
- Input: `0::integer, 0::integer, 0::integer, 0::integer, 0::integer`
- Generated SQL: `SELECT "public"."board_updatenoticepermission"(0::integer, 0::integer, 0::integer, 0::integer, 0::integer);`
- SQLSTATE: `42702`
- Error: column reference "userno" is ambiguous
...
- Generated SQL: `SELECT "public"."board_updaterecommendpublic"(0::bigint, false);`
- SQLSTATE: `42702`
- Error: column reference "contentno" is ambiguous
...
- Input: `0::integer, 0::integer`
- Generated SQL: `SELECT "public"."contacts_deleteallgroupbyuserseq"(0::integer, 0::integer);`
- SQLSTATE: `42702`
...
- Input: `0::integer, 0::integer`
- Generated SQL: `SELECT "public"."contacts_getgroupbyuser"(0::integer, 0::integer);`
- SQLSTATE: `42702`
- Error: column reference "reguserno" is ambiguous
...
- Input: `0::integer, ''::character varying, 0::integer`
- Generated SQL: `SELECT "public"."contacts_insertpublicgroup"(0::integer, ''::character varying, 0::integer);`
- SQLSTATE: `42702`
- Error: column reference "sort" is ambiguous
...
- Input: `0::integer, ''::character varying, 0::integer`
- Generated SQL: `SELECT "public"."contacts_insertsharegroup"(0::integer, ''::character varying, 0::integer);`
- SQLSTATE: `42702`
- Error: column reference "sort" is ambiguous
...
- Generated SQL: `SELECT "public"."contacts_saveaddressinfo"(0::integer, 0::integer, 0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, 0::integer, ''::character varying);`
- SQLSTATE: `42804`
...
- Input: `0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, 0::integer, ''::character varying, 0::integer, 0::integer`
- Generated SQL: `SELECT "public"."contacts_saveaddressinfo_web"(0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, 0::integer, ''::character varying, 0::integer, 0::integer);`
- SQLSTATE: `42704`
- Error: type "tinyint" does not exist
- Stack context: PL/pgSQL function contacts_saveaddressinfo_web(integer,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,integer,character varying,integer,integer) line 141 at SQL statement
- Root cause: Runtime PostgreSQL error requiring procedure-specific investigation
- Proposed fix: Investigate against source definition and rerun the recorded invocation after a scoped fix.
- Validation after fix: NOT YET PASS
...
```sql
CREATE OR REPLACE FUNCTION public.contacts_saveaddressinfo_web(seq integer DEFAULT 7961, firstname character varying DEFAULT 'RM'::character varying, lastname character varying DEFAULT 'Mr'::character varying, callname character varying DEFAULT 'A'::character varying, telinfo character varying DEFAULT '0,0,Cellular Phone,010-3654-0000$0,3,Fax,'::character varying, emailinfo character varying DEFAULT '0,Mr kim@naver.com'::character varying, companyinfo character varying DEFAULT '0,,,3333333'::character varying, addressinfo character varying DEFAULT '$0#1#Home####null#null#'::character varying, homepageinfo character varying DEFAULT ''::character varying, snsinfo character varying DEFAULT ''::character varying, groupinfo character varying DEFAULT '644'::character varying, memo character varying DEFAULT ''::character varying, share character varying DEFAULT '100'::character varying, important integer DEFAULT 1, photo character varying DEFAULT ''::character varying, userno integer DEFAULT 70, listgroup integer DEFAULT 847)
 RETURNS SETOF record
 LANGUAGE plpgsql
AS $function$
DECLARE
...
- Input: `0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying`
- Generated SQL: `SELECT "public"."contacts_savearrange"(0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying);`
- SQLSTATE: `42883`
- Error: function len(character varying) does not exist
- Stack context: PL/pgSQL function contacts_savearrange(integer,character varying,character varying,character varying,character varying) line 49 at IF
- Root cause: Missing function or incompatible invocation signature
- Proposed fix: Verify the expected helper/signature and create or convert it only if it exists in the source system.
- Validation after fix: NOT YET PASS
...
```sql
CREATE OR REPLACE FUNCTION public.contacts_savearrange(userno integer, mainseqlist character varying, namelist character varying, emaillist character varying, numberlist character varying)
 RETURNS SETOF record
 LANGUAGE plpgsql
AS $function$
DECLARE
				...
				WHILE STRPOS(TempNumberList, '$') > 0 LOOP
					...
					IF TempMainSeqNo = TempNumberMainSeq THEN
						IF TempMainSeqNo <> TempNumberUserSeq THEN
							RAISE NOTICE '%', TempDelUserSeqList;
...
- Input: `0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying`
- Generated SQL: `SELECT "public"."contacts_savearrangelike"(0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying);`
- SQLSTATE: `42883`
- Error: function len(character varying) does not exist
- Stack context: PL/pgSQL function contacts_savearrangelike(integer,character varying,character varying,character varying,character varying) line 49 at IF
- Root cause: Missing function or incompatible invocation signature
- Proposed fix: Verify the expected helper/signature and create or convert it only if it exists in the source system.
- Validation after fix: NOT YET PASS
...
```sql
CREATE OR REPLACE FUNCTION public.contacts_savearrangelike(userno integer, mainseqlist character varying, namelist character varying, emaillist character varying, numberlist character varying)
 RETURNS SETOF record
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
	...
	TempMainSeqList := contacts_savearrangelike.mainseqlist || ',';
	CheckMainSeqList := REPLACE(TempMainSeqList,',','');
	-- 정리할 주소록이 있는지 검사
	IF LEN(CheckMainSeqList) > 0 THEN
		...
		WHILE STRPOS(TempMainSeqList, ',') > 0 LOOP
			...
			TempNameList := contacts_savearrangelike.namelist || '$';
			CheckNameList := REPLACE(REPLACE(TempNameList,',',''),'$',',');
			IF LEN(CheckNameList) > 0 THEN
				WHILE STRPOS(TempNameList, '$') > 0 LOOP
			...
			TempEmailList := contacts_savearrangelike.emaillist || '$';
			CheckEmailList := REPLACE(REPLACE(TempEmailList,',',''),'$','');
			-- // ========================
			-- // 이메일 데이터 체크
			-- // ========================
			...
			TempNumberList := contacts_savearrangelike.numberlist || '$';
			CheckNumberList := REPLACE(REPLACE(TempNumberList,',',''),'$','');
			-- // ========================
			-- // 전화번호 데이터 체크
			-- // ========================
...
- Input: `''::character varying`
- Generated SQL: `SELECT "public"."contacts_saverestore"(''::character varying);`
- SQLSTATE: `42883`
- Error: function len(character varying) does not exist
- Stack context: PL/pgSQL function contacts_saverestore(character varying) line 15 at IF
- Root cause: Missing function or incompatible invocation signature
- Proposed fix: Verify the expected helper/signature and create or convert it only if it exists in the source system.
- Validation after fix: NOT YET PASS
...
```sql
CREATE OR REPLACE FUNCTION public.contacts_saverestore(historynolist character varying)
 RETURNS SETOF record
 LANGUAGE plpgsql
AS $function$
DECLARE
...
- Generated SQL: `SELECT "public"."contacts_setshare"(0::integer, 0::integer, ''::character varying, ''::character varying);`
- SQLSTATE: `42883`
- Error: operator does not exist: character varying = integer
...
- Input: `0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, 0::integer, ''::character varying, 0::integer, 0::integer`
- Generated SQL: `SELECT "public"."contacts_updateuserinfo"(0::integer, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, ''::character varying, 0::integer, ''::character varying, 0::integer, 0::integer);`
- SQLSTATE: `42704`
- Error: type "tinyint" does not exist
- Stack context: PL/pgSQL function contacts_updateuserinfo(integer,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,character varying,integer,character varying,integer,integer) line 135 at SQL statement
- Root cause: Runtime PostgreSQL error requiring procedure-specific investigation
- Proposed fix: Investigate against source definition and rerun the recorded invocation after a scoped fix.
- Validation after fix: NOT YET PASS
...
```sql
CREATE OR REPLACE FUNCTION public.contacts_updateuserinfo(seq integer DEFAULT 7959, firstname character varying DEFAULT '대표'::character varying, lastname character varying DEFAULT 'Mr'::character varying, callname character varying DEFAULT 'C'::character varying, telinfo character varying DEFAULT '0,0,Cellular Phone,010-3654-0002$0,2,Company,02-515-36216'::character varying, emailinfo character varying DEFAULT '0,Mr kim@naver.com'::character varying, companyinfo character varying DEFAULT '0,뉴델,,'::character varying, addressinfo character varying DEFAULT '0#0#Company###경기 김포시 월곶면 고정로 13###'::character varying, homepageinfo character varying DEFAULT ''::character varying, snsinfo character varying DEFAULT ''::character varying, memo character varying DEFAULT ''::character varying, share character varying DEFAULT '300'::character varying, important integer DEFAULT 0, photo character varying DEFAULT ''::character varying, userno integer DEFAULT 70, listgroup integer DEFAULT 1028)
 RETURNS SETOF record
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
	...
	IF Seq = 0 THEN
		...
		IF LEN(ChkTelInfo) > 0 THEN -- 값이 존재하는지 체크
			-- 전화정보가 존재하면 끝에 $ 추가;
			TelInfo := contacts_updateuserinfo.telinfo || '$';
			-- Row 분리
			WHILE STRPOS(TelInfo, '$') > 0 LOOP
		...
		ChkEmailInfo := REPLACE(EmailInfo,',','');
		IF LEN(ChkEmailInfo) > 0 THEN
			EmailInfo := contacts_updateuserinfo.emailinfo || '$';
			-- Row 분리
			WHILE STRPOS(EmailInfo, '$') > 0 LOOP
			...
			SELECT UserNo, Seq, Value, IsDefault, NOW(), NOW() FROM tabEmail;
		ELSE
			DELETE FROM ContactsEmail WHERE RegUserNo = contacts_updateuserinfo.userno And UserSeq = contacts_updateuserinfo.seq;
		END IF;
		-- ============================================
		-- 회사
		-- ============================================
		...
		ChkCompanyInfo := REPLACE(CompanyInfo,',','');
		IF LEN(ChkCompanyInfo) > 0 THEN
			CompanyInfo := contacts_updateuserinfo.companyinfo || '$';
			-- Row 분리
			WHILE STRPOS(CompanyInfo, '$') > 0 LOOP
		...
		ChkAddrInfo := REPLACE(AddressInfo,'#','');
		IF LEN(ChkAddrInfo) > 0 THEN
			AddressInfo := contacts_updateuserinfo.addressinfo || '$';
			-- Row 분리
			WHILE STRPOS(AddressInfo, '$') > 0 LOOP
		...
		IF LEN(ChkHomeInfo) > 0 THEN -- 값이 존재하는지 체크
			-- 정보가 존재하면 끝에 $ 추가;
			HomepageInfo := contacts_updateuserinfo.homepageinfo || '$';
			-- Row 분리
			WHILE STRPOS(HomepageInfo, '$') > 0 LOOP
		...
		IF LEN(ChkSnsInfo) > 0 THEN -- 값이 존재하는지 체크
			-- 정보가 존재하면 끝에 $ 추가;
			SnsInfo := contacts_updateuserinfo.snsinfo || '$';
			-- Row 분리
			WHILE STRPOS(SnsInfo, '$') > 0 LOOP
	...
	ELSE
		...
		SET
			...
			LastName = contacts_updateuserinfo.lastname,
			CallName = contacts_updateuserinfo.callname,
			Memo = contacts_updateuserinfo.memo,
			Share = contacts_updateuserinfo.share,
			Photo = contacts_updateuserinfo.photo,
			Important = contacts_updateuserinfo.important,
			ModDate = NOW()
		...
		ChkTelInfoUp := REPLACE(TelInfo,',','');
		DELETE FROM ContactsNumber WHERE  UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
		...
		ChkEmailInfoUp := REPLACE(EmailInfo,',','');
		DELETE FROM ContactsEmail WHERE  UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
		...
		ChkCompanyInfoUp := REPLACE(CompanyInfo,',','');
		DELETE FROM ContactsCompany WHERE  UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
		...
		ChkAddrInfoUp := REPLACE(AddressInfo,'#','');
		DELETE FROM ContactsAddress WHERE  UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
		...
		ChkHomeInfoUp := REPLACE(HomepageInfo,',','');
		DELETE FROM ContactsHomepage WHERE UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
		...
		ChkSnsInfoUp := REPLACE(SnsInfo,',','');
		DELETE FROM ContactsSns WHERE UserSeq = contacts_updateuserinfo.seq; -- and RegUserNo = UserNo
