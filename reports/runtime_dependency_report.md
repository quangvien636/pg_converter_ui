...
| `board_getallboardcontents` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getallboardwidget` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getandroiddeviceofusersbydepartment` | `42883` | function fn_getchilddepartnobydepartno(character varying, character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getboardbyuserno` | `42883` | operator does not exist: ~ boolean | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getboardcommunitywidget` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_getboardcontentinfo` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getboards` | `42P01` | relation "user_depart" does not exist | Unresolved | Create the source-owned schema dependency, or document it as external with evidence. |
| `board_getboards_bk` | `42883` | function public.organization_getdepartmentsbyuser(integer) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getboards_improved` | `42P01` | relation "user_depart" does not exist | Unresolved | Create the source-owned schema dependency, or document it as external with evidence. |
| `board_getcurrentmanagerlist` | `42883` | function public.uf_departmentname(integer) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_getlistboardcontent` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistboardcontent_bk` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistboardcontent_search` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistboardcontentbyfolder` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistboardcontentsearch` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistboardcontenttoexcel` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getlistcommentsetting` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_getmultiwidget` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getnewboardwidget` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_getprenextcontent` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getsettingcommunitywidget` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_getsubmenus` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_gettreesubmenu` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `board_gettreesubmenu_v2` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `board_gettreesubmenutest` | `42883` | function parsejson(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_checkgroup` | `42883` | operator does not exist: integer = character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_finduser` | `42883` | function public.uf_regularextext(character varying) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getallcontactslist` | `42883` | operator does not exist: text = integer | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getallgroup` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getalluser_distinct` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getcontactgroup` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_getcountchilduser` | `42883` | function public.getchildgroup(integer, integer) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_getgroupbyseq` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getonerowchildgroup` | `42883` | function public.getchildgroup(integer, integer) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getoutfile` | `42883` | function public.uf_contactsdetail(integer, unknown) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getoutfileexcel` | `42883` | function public.uf_contactsdetailexcel(integer, unknown) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getoutlist` | `42883` | function public.uf_contactsdetail(integer, unknown) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getoutlistexcel` | `42883` | function public.uf_contactsdetailexcel(integer, unknown) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getpublicgroup` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getsharegroup` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getsharegroupbyuser` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getsharegroupsetting` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuser` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuser_department` | `42883` | function organization_getdepartmentsbyuser(integer) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuser_share` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_getuser_togroupmobile` | `42883` | operator does not exist: character = boolean | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuser_ungroup` | `42883` | operator does not exist: character = boolean | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuserbypublicgroup` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getuserbysharegroup` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_getusergroupbylanguage` | `42883` | function parsejson(text) does not exist | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
| `contacts_getusernumber` | `42883` | operator does not exist: integer = character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_searchmobi` | `42883` | operator does not exist: character varying + character varying | Unresolved | Verify the expected helper/signature and create or convert it only if it exists in the source system. |
...
| `contacts_setcontactsuser` | `0A000` | set-valued function called in context that cannot accept a set | Metadata unavailable | Obtain reviewed result columns from SQL Server metadata, then invoke with AS result(column type, ...). |
