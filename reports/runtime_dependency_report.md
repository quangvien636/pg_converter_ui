...
| `board_getallboardcontents` | `42703` | column "month" does not exist | Unresolved | Create the source-owned schema dependency, or document it as external with evidence. |
