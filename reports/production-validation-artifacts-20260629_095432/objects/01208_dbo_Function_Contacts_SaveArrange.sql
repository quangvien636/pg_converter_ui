-- ─── FUNCTION: contacts_savearrange ───────────────────────────────
DROP FUNCTION IF EXISTS public.contacts_savearrange(character varying);
...
BEGIN
	...
	SET TempMainSeqList = contacts_savearrange.mainseqlist || ','
