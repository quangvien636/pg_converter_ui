...
select PARENTNO=ParentNo,SORTNO=SortNo from Board_Folders where FolderNo= board_downfolder.folderno
SET RANKTEMPNO=1
...
WHILE @FETCH_STATUS = 0
   BEGIN	;
		...
		IF (FOLDERTEMPNO=board_downfolder.folderno)
		BEGIN
