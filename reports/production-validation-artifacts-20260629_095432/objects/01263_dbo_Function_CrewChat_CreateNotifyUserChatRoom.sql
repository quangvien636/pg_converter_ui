-- ─── FUNCTION: crewchat_createnotifyuserchatroom ───────────────────────────────
...
BEGIN
	...
	IF RoomNo > 0 BEGIN
		...
		SET RoomTitle = (SELECT RoomTitle FROM CrewChat_RoomUsers WHERE RoomNo = RoomNo AND UserNo=crewchat_createnotifyuserchatroom.userno)
		-- 기존 1:1 채팅방이 존재합니다.
		RETURN QUERY
