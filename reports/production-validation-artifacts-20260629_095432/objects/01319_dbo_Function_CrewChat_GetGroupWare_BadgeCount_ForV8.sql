-- ─── FUNCTION: crewchat_getgroupware_badgecount_forv8 ───────────────────────────────
...
BEGIN
	...
	SET UserID = (SELECT /* TOP 1 */ UserID FROM Organization_Users WHERE UserNo=crewchat_getgroupware_badgecount_forv8.userno AND Enabled = TRUE)
