-- ─── FUNCTION: schedule_insertresourcenotificationservice ───────────────────────────────
...
BEGIN
	...
	-- get Notification ID
	select /* TOP 1 */ NotificationNo = NotificationNo from  Center_NotificationService where ProjectCode = schedule_insertresourcenotificationservice.projectcode and Connectionkey = schedule_insertresourcenotificationservice.connectionkey  
