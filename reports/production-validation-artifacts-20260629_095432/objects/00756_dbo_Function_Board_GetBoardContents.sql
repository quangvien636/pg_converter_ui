-- ─── FUNCTION: board_getboardcontents ───────────────────────────────
...
CREATE OR REPLACE FUNCTION public.board_getboardcontents(
    ...
    countperpage integer DEFAULT 1,
    currentpageindex integer DEFAULT 10,
    ...
    todate timestamp without time zone DEFAULT '2019-01-01 19:20:19.717',
...
where BSS1.contentno=BC.ContentNo and BSS1.userno=' || CONVERT(nvarchar(10),UserNo ) +  ')) OR ((SELECT COUNT(*) FROM Board_Sharers BS2 WHERE BS2.CONTENTNO = BC.ContentNO) <=0 ) )'
	...
	SET EndRowNum = board_getboardcontents.currentpageindex * CountPerPage
	...
	FROM Board_Boards WHERE BoardNo = board_getboardcontents.boardno
