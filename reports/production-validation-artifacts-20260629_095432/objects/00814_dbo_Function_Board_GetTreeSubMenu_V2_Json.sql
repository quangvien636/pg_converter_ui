-- ─── FUNCTION: board_gettreesubmenu_v2_json ───────────────────────────────
...
CREATE OR REPLACE FUNCTION public.board_gettreesubmenu_v2_json(
    ...
    selectedboardno integer DEFAULT 0,
    selectedfolderno integer DEFAULT 0
) RETURNS TABLE(
    col1 text
)
...
BEGIN
    ...
    SELECT
        ...
        CAST(CASE WHEN IsFolder = TRUE AND No = board_gettreesubmenu_v2_json.selectedfolderno THEN 1
                  ...
                  ELSE 0 END AS BIT) AS IsSelected
    INTO #T FROM TREESUB;
    ...
    RETURN QUERY
    SELECT No, IsFolder, SortPath INTO #O FROM DFS;
