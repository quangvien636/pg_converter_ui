-- ─── FUNCTION: integrated_getsearchmultitable ───────────────────────────────
...
BEGIN
	...
	SET Query  =  'SELECT T.Id ,T.BoardNo as CatNo, T.Title,T.RegUserNo, T.RegDate, T.PositionName, T.DepartName , T.CatName, T.UserName, T.ReadCount, 3 as TableType'	
	SET Query += ' FROM ('
	...
	SET Query1  =  'SELECT  T.IntegratedNo as Id ,T.DivisionNo as CatNo,T.Title,T.RegUserNo, T.RegDate,  T.PositionName, T.Department as DepartName, T.TreeName as CatName, T.UserName, T.ViewUserCnt as ReadCount'
	...
	---------------------- NoticeSyn --------------------------
	SET Query2  =  'SELECT  T.NoticeNo as Id ,T.DivisionNo as CatNo,T.Title,T.RegUserNo, T.RegDate,T.PositionName, T.Department as DepartName, T.DivisionName as CatName, T.UserName, T.ViewUserCnt as ReadCount'
