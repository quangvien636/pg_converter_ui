-- ─── FUNCTION: board_updatenotificationservice ───────────────────────────────
...
BEGIN
	...
	-- get Notification ID
	select /* TOP 1 */ NotificationNo = NotificationNo from  Center_NotificationService where CompanyNo = board_updatenotificationservice.companyno and ProjectCode = board_updatenotificationservice.projectcode and Connectionkey = board_updatenotificationservice.connectionkey 
