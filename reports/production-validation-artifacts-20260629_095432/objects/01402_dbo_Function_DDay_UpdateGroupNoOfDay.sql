-- ─── FUNCTION: dday_updategroupnoofday ───────────────────────────────
...
BEGIN
	...
	SET RegUserNo = (SELECT RegUserNo FROM DDay_Days WHERE DayNo = dday_updategroupnoofday.dayno)

	IF (RegUserNo = dday_updategroupnoofday.moduserno) BEGIN
	...
	ELSE BEGIN
		...
		SET Count = (SELECT COUNT(*) FROM DDay_GroupInfoOfSharedDays WHERE DayNo = dday_updategroupnoofday.dayno AND UserNo = dday_updategroupnoofday.moduserno)
