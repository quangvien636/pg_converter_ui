-- ─── PROCEDURE→FUNCTION: workingtime_getsettingbyuser ───────────────────────────────
...
BEGIN
		...
		CREATE TEMP TABLE tam AS SELECT * FROM Organization_Users WHERE UserNo = workingtime_getsettingbyuser.p_uno;
		   RETURN QUERY
		   SELECT
