-- ─── PROCEDURE→FUNCTION: mail_getmails_forsharemailbox ───────────────────────────────
...
BEGIN
	...
	EXECUTE format(Query, UserNo, BoxNo, SearchText);
	/*
	 * 
	 */
	...
	EndRowNum := mail_getmails_forsharemailbox.currentpageindex * CountPerPage;
	RETURN QUERY
