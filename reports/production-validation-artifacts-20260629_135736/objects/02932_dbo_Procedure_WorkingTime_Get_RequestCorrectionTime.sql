-- ─── PROCEDURE→FUNCTION: workingtime_get_requestcorrectiontime ───────────────────────────────
...
CREATE OR REPLACE FUNCTION public.workingtime_get_requestcorrectiontime(
    ...
    IN usernoinput integer,
    IN usertype integer,
    IN pagenumber integer DEFAULT 0,
    IN sort character varying DEFAULT 'Status',
    IN pagesize integer DEFAULT 30
...
BEGIN
  ...
  PERFORM workingtime_getallchilddepartbyuid(usernoinput);
