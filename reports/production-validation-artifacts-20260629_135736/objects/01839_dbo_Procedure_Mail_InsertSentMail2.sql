...
CREATE OR REPLACE FUNCTION public.mail_insertsentmail2(
    ...
    IN addresses character varying,
    IN regdate date
...
BEGIN
	...
	VALUES (
		...
		2, Size, IsFile, FileCount, RegDate, ReserveDate, RegDate, ''
	)
	...
	WHERE BoxNo = mail_insertsentmail2.boxno

	UPDATE Mail_UserSettings
	CurrentMailBoxSize := CurrentMailBoxSize + Size;
	WHERE UserNo = mail_insertsentmail2.userno
	...
	WHERE MailNo = mail_insertsentmail2.originalmailno
