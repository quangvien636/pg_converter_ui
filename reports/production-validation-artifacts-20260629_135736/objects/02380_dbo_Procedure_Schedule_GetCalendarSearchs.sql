-- ─── PROCEDURE→FUNCTION: schedule_getcalendarsearchs ───────────────────────────────
...
CREATE OR REPLACE FUNCTION public.schedule_getcalendarsearchs(
    IN calendar_type character varying DEFAULT 'A',
    IN search_text character varying DEFAULT '',
    IN schedule_check integer DEFAULT 1,
    IN todo_check integer DEFAULT 1,
    IN d_day_check integer DEFAULT 1,
    IN start_date date DEFAULT '1900-01-01',
    IN end_date date DEFAULT '9999-12-31',
    IN page_size integer DEFAULT 10,
    IN schd_page integer DEFAULT 1,
    IN todo_page integer DEFAULT 1,
    IN dday_page integer DEFAULT 1
