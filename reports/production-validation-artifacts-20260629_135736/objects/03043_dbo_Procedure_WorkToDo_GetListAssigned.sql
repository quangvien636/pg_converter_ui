-- ─── PROCEDURE→FUNCTION: worktodo_getlistassigned ───────────────────────────────
...
BEGIN
	...
	EXECUTE format(Query, UserNo, StartDate, EndDate);
	...
	EndRowNum := worktodo_getlistassigned.currentpageindex * CountPerPage;
	RETURN QUERY
