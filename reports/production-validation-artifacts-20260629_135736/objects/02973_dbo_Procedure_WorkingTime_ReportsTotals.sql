-- ─── PROCEDURE→FUNCTION: workingtime_reportstotals ───────────────────────────────
...
CREATE TEMP TABLE U1 AS SELECT t.UserNo
...
(
	...
	SELECT B.UserNo FROM  (CREATE TEMP TABLE W1 AS SELECT u1.* FROM Organization_Users U1 
		...
		SELECT wt.UserNo
				...
				,wt.WorkingDay
				,wt.Provider FROM WorkingTime_Times wt
