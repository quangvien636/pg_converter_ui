-- ─── PROCEDURE→FUNCTION: note_getlistnotesmaps_total ───────────────────────────────
...
CREATE OR REPLACE FUNCTION public.note_getlistnotesmaps_total(
    ...
    IN lng1 double precision DEFAULT 0
...
BEGIN
	...
	IF GroupNo = '00000000-0000-0000-0000-000000000000' THEN
		Total := (COUNT(ListNo), MaxDictance = MAX(public."DictanceKM"(lat1,lng1,Latitude, Longitude)), MinDictance = MIN(public."DictanceKM"(lat1,lng1,Latitude, Longitude)));
