-- ─── PROCEDURE→FUNCTION: schedule_updateresourcenotificationservice ───────────────────────────────
...
BEGIN
	...
	-- get Notification ID
	CREATE TEMP TABLE tb AS SELECT /* TOP 1 */ NotificationNo = NotificationNo from  Center_NotificationService where CompanyNo = schedule_updateresourcenotificationservice.companyno and ProjectCode = schedule_updateresourcenotificationservice.projectcode and Connectionkey = schedule_updateresourcenotificationservice.connectionkey 
