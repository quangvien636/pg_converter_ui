-- ─── PROCEDURE→FUNCTION: work_insertadminworkjournaldivisions ───────────────────────────────
...
BEGIN
	...
	SortNo := (SELECT MAX(SortNo) FROM WorkJournalDivisions WHERE ParentNo = work_insertadminworkjournaldivisions.parentno);
