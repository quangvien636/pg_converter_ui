...
CREATE OR REPLACE FUNCTION public.board_getallboardcontents(
    IN _userno integer DEFAULT 70,
    IN _sortcolumn integer DEFAULT 1,
    IN _isascending boolean DEFAULT FALSE,
    IN _countperpage integer DEFAULT 10,
    IN _currentpageindex integer DEFAULT 1,
    IN _languagesign character varying DEFAULT 'KO',
    IN _filtertype integer DEFAULT 100,
    IN _viewmode integer DEFAULT -1,
    IN _fromdate timestamp without time zone DEFAULT '2000-01-01 00:00:00',
    IN _todate timestamp without time zone DEFAULT '2028-11-29 11:09:58.860',
    IN _typeeff integer DEFAULT 1,
    IN _isalarm boolean DEFAULT FALSE,
    IN _isadmin boolean DEFAULT TRUE,
    IN _searchtype integer DEFAULT 0,
    IN _searchvalue character varying DEFAULT ''
